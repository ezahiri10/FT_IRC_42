...
#define ERR_SPACENOTALLOWED(command)					PREFIX "463 " + command + " :Password cannot contain spaces" POSTFIX //added
...
//Replays :
#define RPL_WELCOME(nick)                               PREFIX "001 " + nick + " :Welcome To The Server" POSTFIX
