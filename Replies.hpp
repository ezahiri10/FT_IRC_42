...
#define IRC_RED "\x034"
#define IRC_YELLOW "\x038"
#define IRC_GREEN "\x033"
#define IRC_RESET "\x03"
...
#define ERR_USERSDONTMATCH(client) PREFIX "502 " + client + " :Can't change mode for other users" POSTFIX
...
#define ERR_ERRONEUSNICKNAME(nick) PREFIX "432 " + nick + " :Erroneous nickname" POSTFIX 
...
#define ERR_ALREADYREGISTRED(target) PREFIX "462 " + target + " :You may not re-register" POSTFIX 
...
#define ERR_NEEDMODEPARM(channelname, mode) PREFIX "696 " + channelname + " * You must specify a parameter for the key mode. " + mode + POSTFIX
#define ERR_UNKNOWNMODE(nickname, channelname, mode) PREFIX "472 " + nickname + " " + channelname + " " + mode + " :is not a recognised channel mode" POSTFIX
#define ERR_INCORPASS(nickname) PREFIX "464 " + nickname + " :Password incorrect!" POSTFIX

#define RPL_WELCOME(sender, msg) IRC_GREEN PREFIX "001 " + sender + " : " + msg + POSTFIX IRC_RESET
