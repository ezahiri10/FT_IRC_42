...
/*   Updated: 2025/02/25 22:03:40 by ael-fagr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int Server::Invite_client(std::string arg, std::string invit_client, std::string channel, int client_Fd)
{
    ...
    if (there_is_channel(channel, channel_pos, client_Fd)
        ...
        /*&& !already_on_channel(invit_client, channel, client_Fd, channel_pos, 1)*/
        && Check_Channel_Op(this, Get_client_nick(client_Fd), channel, channel_pos, client_Fd))
    {
