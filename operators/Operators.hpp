...
class Operators {
    private:
        ...
        void Add_Remove_OP(Server &My_serv, std::string mode, std::string op, int channel_pos, int clientId);
        void Add_Remove_PASS(Server &My_serv, std::string mode, std::string pass, int channel_pos, int Client_id);
    ...
    public:
        ...
        void Add_Mode(Server &My_serv, std::string mode, int channel_pos, int Client_id);
